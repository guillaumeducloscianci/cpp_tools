...
class TestDirectoryRemove(SystemTest):

    def test_remove_on_non_existing_directory(self):
        self.assert_directory_does_not_exist("non_existing_directory")
        Directory.remove("non_existing_directory")
