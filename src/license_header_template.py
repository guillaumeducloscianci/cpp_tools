...
class LicenseHeaderTemplate():
    file_template = FileTemplate(File.read(cpp_tools_resources_directory/"license_header.template"))

    @classmethod
    def instantiate_with(cls, project_name, author):
        return cls.file_template.instantiate_with(cls.create_replacement_rules(project_name, author))
